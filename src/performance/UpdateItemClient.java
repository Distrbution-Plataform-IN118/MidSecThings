...
public class UpdateItemClient {
	...
	public static void main(String[] args) throws UnknownHostException, IOException, Throwable {
		...
		for (int i = 0; i < Metrics.SAMPLE; i++) {
			...
			smarthome.atualizaItem(token_rick,CeilingHub.Light_GF_Corridor_Ceiling, "ON");
		...
		WriteExcel excel = new WriteExcel("C:/Users/Richardson/Documents/Update_Item_Invoker.xls");
		excel.init();
		...
		excel = new WriteExcel("C:/Users/Richardson/Documents/Update_Item_Unmarshall.xls");
		excel.init();
		...
		excel = new WriteExcel("C:/Users/Richardson/Documents/Update_Item_Rtt.xls");
		excel.init();
